...
public class book_x extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_x);
        Intent i =getIntent();
        String name = i.getStringExtra("name");
        borrowRepo = new BorrowRepo();
        Cursor data = borrowRepo.fetch_all_borrow_bookname(name);
        ...
        listView = (ListView) findViewById(R.id.listview_bookx);
